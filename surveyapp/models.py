...
class Subsession(BaseSubsession):
    def creating_session(subsession):
        ...
        for player in subsession.get_players():
            #Ciclos para que los tratamientos queden balanceados
...
class Player(BasePlayer):
    ### Variables para guardar los tratamientos aleatorizdos e imágenes aleatorizadas de sociedades
    ...
    edad = models.IntegerField(label= "", choices = [[1,"18 años a 25 años"],[2,"Mayor de 25 años"]], blank = True)
    ...
    estado = models.IntegerField(label="",
                                   choices=[
                                       [1, "Aguascalientes"],
                                       [2, "Baja California"],
                                       [3, "Baja California Sur"],
