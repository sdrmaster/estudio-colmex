...
class Inicio(Page):
    form_model = "player"
    form_fields = ["participa", ]
class SurveyQuestions(Page):
    form_model = "player"
    form_fields = ["edad", "sexo", "es_civil","nacimiento","estado","educacion","empleo","ingreso_hogar"]
...
page_sequence = [Inicio, Percepciones,  Percepciones2, Percepciones3, Percepciones4, Percepciones5, Ideales, Ideales2, Ideales3, Ideales4, Cree, Debe, T1, T2, T3,  PTratamiento, SurveyQuestions, SurveyFinal]
